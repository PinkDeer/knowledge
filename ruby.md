...
Символ косой черты (\) и следующий за ним символ n образует служебную последовательность — часть строки, представляющую символы, которые не имеют обычного представления в исходном код.
