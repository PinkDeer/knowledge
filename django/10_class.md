...
Ипортироваит функцию view и заменить фунции на методы
...
Если ввести несуществующий адресс _post/tratata_, то выдаст ошибку DoesNorExist, чтобы появилась ошибка 404, нужно импортировать специальный метод и редактировать класс
