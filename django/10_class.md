...
Если ввести несуществующий адресс post/tratata, то выдаст ошибку DoesNorExist, чтобы было 404, нужно импортировать специальный метод и редактировать класс
